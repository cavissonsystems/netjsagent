...
ndMetaDataRecoveryProcess.handleCurrRecord = function(clientMsg, typeOfRecordField, clientSocket){
    ...
    {
        ndMetaDataRecoveryProcess.checkAndSendCachedRecord(21, typeOfRecordField, clientSocket);
    }
...
ndMetaDataRecoveryProcess.findRecordTypeAndSendCachedData = function(index, recTpe, isSpecific, isMultiple, clientSocket){
    ...
    switch (recTpe)
    {
        ...
        case 21:
            ...
            break;
        case 32:
            ndMetaDataRecoveryProcess.collectAndSendOnlyCached32Records(index, isSpecific, isMultiple, clientSocket);
            break;
        case 33:
            ndMetaDataRecoveryProcess.collectAndSendOnlyCached33Records(index, isSpecific, isMultiple, clientSocket);
            break;
        case 34:
            ndMetaDataRecoveryProcess.collectAndSendOnlyCached34Records(index, isSpecific, isMultiple, clientSocket);
            break;
        case 35:
            ndMetaDataRecoveryProcess.collectAndSendOnlyCached35Records(index, isSpecific, isMultiple, clientSocket);
            break;
        case 41:
