...
AgentSetting.checkNDSettingsInEnv = function(){
    ...
    var saas_url = process.env.CAV_APP_AGENT_NDSAASURL;
    if(!isEmpty(pr_key) && !isEmpty(saas_url))
    {
        ...
        if(!isEmpty(saas_url)){             // if URL is provided
    ...
    if(!isEmpty(ndc_host) && !isEmpty(ndc_port))
