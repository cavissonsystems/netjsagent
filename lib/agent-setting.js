...
AgentSetting.getData = function (filename) {
    ...
    try {
        ...
        util.logger.info(AgentSetting.currentTestRun + " | NDCHost is  : " + AgentSetting.ndcPort);
        util.logger.info(AgentSetting.currentTestRun + " | NDCPort is  : " + AgentSetting.ndcHost);
        util.logger.info(AgentSetting.currentTestRun + " | heapDump  : " + AgentSetting.enable_heapdump);
        util.logger.info(AgentSetting.currentTestRun + " | cpuProfiling : " + AgentSetting.enable_cpu_profiling);
