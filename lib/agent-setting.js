...
AgentSetting.getData = function () {
    try {
        ...
        var webSocketMode = properties.get('webSocketMode')
        ...
        AgentSetting.webSocketMode=webSocketMode;
        if(AgentSetting.webSocketMode == null || AgentSetting.webSocketMode == undefined){
            AgentSetting.webSocketMode = 0
        }
        ...
        util.logger.info(AgentSetting.currentTestRun + " | webSocketMode : " + AgentSetting.webSocketMode);
    }catch(err){util.logger.warn(err)}
};
