...
AgentSetting.startInstrResTimeout = 300000
...
AgentSetting.instrumentNodeEvents = 0;
...
AgentSetting.getData = function () {
    try {
        ...
        var instrumentNodeEvents = properties.get('instrumentNodeEvents');
        if((instrumentNodeEvents != null) && (instrumentNodeEvents != undefined) && (instrumentNodeEvents != 0)) {
            AgentSetting.instrumentNodeEvents = instrumentNodeEvents;
        }
        ...
        util.logger.info(AgentSetting.currentTestRun + " | instrumentNodeEvents : " + AgentSetting.instrumentNodeEvents);
    }catch(err){util.logger.warn(err)}
};
