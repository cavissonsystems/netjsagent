...
AgentSetting.dynamicThreshold = false;
...
AgentSetting.initAllMap = function(BCILoggingMode)
{
    try {
        ...
        if(!BCILoggingMode)
            BCILoggingMode='FILE'
        AgentSetting.BCILoggingMode = BCILoggingMode;
...
AgentSetting.getData = function (filename) {
    ...
    try {
        ...
        util.logger.info(AgentSetting.currentTestRun + " | DynamicThreshold : " + AgentSetting.dynamicThreshold);
