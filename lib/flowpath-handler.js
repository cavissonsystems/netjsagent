	   ...
	   /* if(correlationIDHeader) {
        ...
        if(!cavNVCookie) {
            ...
            if(cavNVCookie.indexOf(",") !== -1) {
                ...
                isInstrumentedSession =  (tmpStr[NDNV_IS_INSTRUMENTED_SESSION_INDEX]?tmpStr[NDNV_IS_INSTRUMENTED_SESSION_INDEX].trim():"1");
            ...
            if(nsFlowpathInstanceID){
                if(nsFlowpathInstanceID.indexOf("_") == -1) {
                    if(nsFlowpathInstanceID == "F" || nsFlowpathInstanceID == "f"){
                        Flowpath.tlFirstTierFPID =flowPathId = fpid+nsFlowpathInstanceID;
                        context.cavIncludeFp = true;
                    }else{
