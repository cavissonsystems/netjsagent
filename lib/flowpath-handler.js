...
flowpathhandler.handleFlowPath = function(req,res,args) {
    ...
    if (req.hasOwnProperty('url') /*&& (header.indexOf('text/html') > -1 || header.indexOf("*!/!*")  > -1)*/ ) {
        ...
        req.cavBtObj = btObj;                                               //Adding btObj in Request
        ...
        * */
        if(!bt_Data) {
            ...
            btManager.createAndUpdateBTRecord(btObj.btId,btObj.btName,"","","",btObj.threshold.dynamicSlowThresoldPct,btObj.threshold.dynamicVSlowThresoldPct);//If BT object is not created and create it at once
