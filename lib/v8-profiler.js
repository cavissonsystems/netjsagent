...
v8_profiler.takeHeapSnapShotOnNewConn = function(clientSocket,dataSocket,clientMsg,asyncId){
    ...
    try {
        ...
        dataSocket.write("run_async_command_data_req:Command=heap_dump;Id=" + asyncId + ";Tier=" + agentSetting.tier + ";Server=" + agentSetting.server + ";Instance=" + agentSetting.instance + ";Size=0;\n")
