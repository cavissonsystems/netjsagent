...
v8_profiler.takeHeapSnapShotOnNewConn = function(clientSocket,dataSocket,clientMsg,asyncId){
    ...
    try {
        ...
        var newDataMsg = "run_async_command_data_req:Command=heap_dump;Id="+asyncId+";Tier="+agentSetting.tier+";Server="+agentSetting.server+";Instance="+agentSetting.instance+";Size=0;\n"
        dataSocket.write(newDataMsg)
        console.log(newDataMsg)
        ...
        stream = snapshot1.export()
            ...
            .on('error', function (e) {
                ...
                delete dataSocket;
                ut.logger.warn(agentSetting.currentTestRun + " | Error accoured during exporting the HeapDump , ERROR : ",e)
