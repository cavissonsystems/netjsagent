...
try{
    v8= require('v8');
}catch(e){console.log('Cant find module v8')}    //v8 package contains heap space statistics
	...
	heapSpace_Size_obj = v8.getHeapSpaceStatistics();
        ...
        for (var i = 0; i < heapSpace_Size_obj.length; i++) {
            ...
            if (heapSpace_Size_obj[i].space_name == "new_space") {
                new_space_tot = parseInt((heapSpace_Size_obj[i].space_size / 1048576).toFixed(3));
                new_space_used = parseInt((heapSpace_Size_obj[i].space_used_size / 1048576).toFixed(3));;

            } else if (heapSpace_Size_obj[i].space_name == "old_space") {
                old_space_tot = parseInt((heapSpace_Size_obj[i].space_size / 1048576).toFixed(3));;
                old_space_used = parseInt((heapSpace_Size_obj[i].space_used_size / 1048576).toFixed(3));;

            } else if (heapSpace_Size_obj[i].space_name == "code_space") {
                code_space_tot = parseInt(( heapSpace_Size_obj[i].space_size / 1048576).toFixed(3));;
                code_space_used = parseInt(( heapSpace_Size_obj[i].space_used_size / 1048576).toFixed(3));

            } else if (heapSpace_Size_obj[i].space_name == "map_space") {
                map_space_tot = parseInt(( heapSpace_Size_obj[i].space_size / 1048576).toFixed(3));
                map_space_used = parseInt(( heapSpace_Size_obj[i].space_used_size / 1048576).toFixed(3));

            } else if (heapSpace_Size_obj[i].space_name == "large_object_space") {
                large_obj_space_tot = parseInt((heapSpace_Size_obj[i].space_size / 1048576).toFixed(3));
                large_obj_space_used = parseInt((heapSpace_Size_obj[i].space_used_size / 1048576).toFixed(3));
