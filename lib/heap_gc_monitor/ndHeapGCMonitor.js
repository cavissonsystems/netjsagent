...
heapGcMonitor.heapGcTimer=undefined;

heapGcMonitor.handleHeapGcMonitor = function(){
    1 == agentSetting.enable_garbage_profiler ? (agentSetting.agentMode >= 1 ?heapGcMonitor.init() :heapGcMonitor.stopHeapGC()) : heapGcMonitor.stopHeapGC();
}
...
heapGcMonitor.init = function ()
{
    try {
        ...
        if (agentSetting.isTestRunning) {
            ...
            if(heapGcMonitor.heapGcTimer === undefined)
