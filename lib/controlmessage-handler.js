...
MessageHandler.prototype.sendIntialMessages = function() {
    ...
    try {
        ...
        if(last_index_ver > -1){
            ...
            if(last_version_field.length > 2) {
		        ...
		        var temp_patch=parseInt(version.slice(-1)-1)
                version=version.slice(0,-1)+temp_patch
            }
        }
    }catch(err){
    ...
    {
        controlMessage = "cav_saas_auth_agent_msg_req:agentVersion=" + build_ver + ";agentStartTime="
