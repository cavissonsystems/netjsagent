            ...
            for(var i=0;i<ndcMsg.length;i++) {
                    ...
                    if (action[1] == "start_instrumentation") {
                        try {
                            ...
                            for (var i = 0; i < messageArray.length; i++) {
                                ...
                                if (propertyValuePairs[0] == "status") {
                                ...
                                * 5- nodejsCpuProfilingTime = This keyword will provide the cpuProfiling waiting time*/
                                ...
                                if (propertyValuePairs[0] == "dynamicSlowVslowThreshold") {
                                ...
                                if (propertyValuePairs[0] == "enableForcedFPChain") {
                                    agentConfReader.enableForcedFPChain = propertyValuePairs[1]
                                    util.logger.info(currTestId + " | gcProfiler : "+agentConfReader.enableForcedFPChain);
                                }
                                if (propertyValuePairs[0] == "nodejsCpuProfilingTime") {
                                ...
                                }if (propertyValuePairs[0] == "bciMaxNonServiceMethodsPerFP") {
                                ...
                                if (propertyValuePairs[0] == "maxBTCount") {
                ...
                //Control message for closing the connection
                   ...
                   // instrProfileParseSuccess = true;//for every instrument profile starting this will be true, if during any failure occur it will false
                    ...
                    try {
                        if (action[1] == "file") {
                            ndcFileData = fileBasedKeywordGenricFile.readFileContent(messageArray[1], clientSocket);
                            readFile = true;
                        }
                    }
                    catch (err) {
    ...
    if(clientMsg.indexOf(";") !== -1) {
        ...
        for (var i in allArguments) {
            ...
            if (argumentAndValue == null || argumentAndValue.length != 2) {
                ...
                agentConfReader.maxCharInSeqBlob = strKeywordValue;
...
MessageHandler.handleRunTimeChangeCase = function(clientMsg,controlSocket) {
    try {
        ...
        if (clientMsg.indexOf("captureCustomData=NA") != -1) {
            ...
            instPrfParseobj.processInstrFileList(messageArray, controlSocket,true);
            controlSocket.write("nd_control_rep:action=modify;result=Ok;" + '\n');
            return;
        }
