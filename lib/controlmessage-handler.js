                ...
                if (strKeywordValue > 0) {
                   /* var instrumentConsole = require('./nodetime/lib/probes/console'),
                    ...
                    if (NDEntryPointManager.entryPointMap['CONSOLE'] && NDEntryPointManager.entryPointMap['CONSOLE'].enable == 1) {
                        instrumentConsole.instrLogsForNF(console, NDEntryPointManager.entryPointMap['CONSOLE'].method);
                    }
                    if (NDEntryPointManager.entryPointMap['WINSTON'] && NDEntryPointManager.entryPointMap['WINSTON'].enable == 1) {
                        instrumentWinston.instrLogsForNF(util.logger, NDEntryPointManager.entryPointMap['WINSTON'].method);
                    }*/
                }
            }
        }
