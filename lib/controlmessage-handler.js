...
MessageHandler.prototype.handleMessages = function() {
    ...
    clientSocket.handleDataEvent(function (content) {
        ...
        util.logger.info(agentConfReader.currentTestRun + " Control message received from ndc : " + data + " . FileMetaData : "+ utilcore.inspect(expectedFileMetaData, false)+" , New Line : "+ (data.toString().indexOf('\n') > -1) +" , PendingChunks : "+ (pendingChunk.length ? pendingChunk : 'No Pending Chunk') +'\n');
