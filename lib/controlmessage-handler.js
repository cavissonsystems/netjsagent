                        ...
                        try {
                            ...
                            for (var i = 0; i < messageArray.length; i++) {
                                ...
                                * 5- nodejsCpuProfilingTime = This keyword will provide the cpuProfiling waiting time*/
                                    ...
                                    agentConfReader.corelateEventCallback = propertyValuePairs[1]
                                    util.logger.info(currTestId + " | corelateEventCallback : "+agentConfReader.corelateEventCallback);
    ...
    if(clientMsg.indexOf(";") !== -1) {
        ...
        for (var i in allArguments) {
            ...
            if (argumentAndValue == null || argumentAndValue.length != 2) {
                ...
                agentConfReader.corelateEventCallback = strKeywordValue
                util.logger.info(agentConfReader.currentTestRun + " | corelateEventCallback : "+agentConfReader.corelateEventCallback);
                require('./utils/instrumentNodeEvents')(agentConfReader.corelateEventCallback, agentConfReader.wrapAsyncApi)
            }
