            ...
            //Control message for closing the connection
                ...
                if (status == "stopping") {
                    if (agentConfReader.dataConnHandler && agentConfReader.dataConnHandler.client) {
                        ...
                        //clean all maps
/*
                        delete agentConfReader.backendMetaMap;
                        delete agentConfReader.backendRecordMap;
                        delete agentConfReader.btrecordMap;
                        delete agentConfReader.categoryMap;
                        delete agentConfReader.flowMap;
                        delete agentConfReader.queryMap;
                        delete methodManager.clearMap();
                        delete flowpathHandler.clearURLMap();*/
