        ...
        object[property] = function () {
            ...
            if(isInstrumentTx) {
                ...
                if (instrumentAsyncFunc) {
                    var cav_args = {eventName : undefined, methodName:undefined, startSeqId : undefined ,args : undefined};
                ...
                if (typeof orig === 'function') {
                    if (arguments[0] != 'close' && arguments[0] != 'error')
                        arguments[cav_callbackArg] = makeWrappedCallback(orig, sourcePosition, property, arguments[0],(cav_args? cav_args.startSeqId : undefined),cav_callbackArg);
                }
            }
