            ...
            if(isInstrumentTx) {
                ...
                if (typeof orig === 'function') {
                    if (arguments[0] != 'close' && arguments[0] != 'error') {
                        arguments[cav_callbackArg] = makeWrappedCallback(orig, sourcePosition, property, arguments[0], cav_args.parentId,cav_callbackArg);
                    }
                }
            }
