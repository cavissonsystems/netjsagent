    ...
    try{
        ...
        for(var i in data){
            ...
            if(validMethod && validType && validEnable){
                ...
                util.logger.error(agentSetting.currentTestRun,'| Invalid data received in NDEnytryPoints File :',data[i]);
            }
        }
        ...
        util.logger.error(agentSetting.currentTestRun,'| Erro while parsing the NDEntryPoints File')
    }
