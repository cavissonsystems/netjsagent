...
NDEntryPointManager.parseEntryPointFile =  function(data){
    this.entryPointMap = {};
    this.isEntryPointConfigured = this.isEntryPointConfigured = this.isMethodInstrEnable = 1;
    this.isRedisExitPointConfigured = this.isMongoExitPointConfigured = this.isHttpExitPointConfigured = 1;
