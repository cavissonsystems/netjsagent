...
autoSensorConnHandler.prototype.connectToServer = function()
{
    ...
    this.timeOut = setTimeout(function () {
        self.timeout=0;
        self._connect();
        util.logger.warn(agent.currentTestRun+" | Timer for retrying Auto Sensor connectoion expired. trying to connect with Host : "+agent.getNDCHost()+" ,Port="+agent.getPort());
    }, 60000);
};
