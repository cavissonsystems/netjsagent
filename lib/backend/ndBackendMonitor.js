...
ndBackendMonitor.make75Data = function(data75){
    ...
    return '75,' + vectorPrefixID + data75.backendID + ':' + vectorPrefix + data75.BackendName + '|' + data75.cumCount + ' ' + data75.rate + ' ' + data75.avgDuration + ' ' + data75.minDuration + ' ' + data75.maxDuration + ' ' + data75.invocationCount + ' ' + data75.errorInvocationCount + '\n';
