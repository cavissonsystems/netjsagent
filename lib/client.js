       ...
       //         util.logger.error(agentSetting.currentTestRun+" | Control connection, Received end event with retrying : "+retrying+", on socket-  " + err);
        ...
        client.on('close', function(err) {
            try {
                ...
                ,serverConfig.currentActiveServer ?serverConfig.currentActiveServer.ndcHost:''," ,Port : ",serverConfig.currentActiveServer ? serverConfig.currentActiveServer.ndcPort:'',' ,error : ', err);}
        });
