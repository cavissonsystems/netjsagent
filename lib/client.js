...
function updateLastConnInfo(){
    try{
        serverConfig.currentActiveServer.connTimeStamp = new Date().getTime();
        agentSetting.lastConnTimeStamp = serverConfig.currentActiveServer.connTimeStamp;
        agentSetting.lastConnHost = serverConfig.currentActiveServer.ndcHost;
        agentSetting.lastConnPort = serverConfig.currentActiveServer.ndcPort;
