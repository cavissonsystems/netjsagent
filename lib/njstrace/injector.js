...
var TRACE_EXIT = '__njsTraceExit__({file: __njsEntryData__.file,name: __njsEntryData__.name,cavMthStartTime:__njsEntryData__.cavMthStartTime,flowPathObj:__njsEntryData__.flowPathObj,methodId:__njsEntryData__.methodId,cavIncludeFp:__njsEntryData__.cavIncludeFp,exception: %s, line: %s, returnValue: %s, args: %s});';
