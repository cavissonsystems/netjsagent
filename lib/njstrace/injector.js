...
var TRACE_EXIT = '__njsTraceExit__({file: __njsEntryData__.file,name: __njsEntryData__.name,cavMthStartTime:__njsEntryData__.cavMthStartTime,exception: %s, line: %s, returnValue: %s, args: %s});';
