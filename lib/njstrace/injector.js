...
var TRACE_ENTRY = 'var __njsEntryData__ = __njsTraceEntry__({file: %s, name: %s, line: %s, args: %s, cavisson_req: typeof _cavisson_defined_req === \'undefined\' ? null:_cavisson_defined_req});';
