...
var TRACE_EXIT = '__njsTraceExit__({file: __njsEntryData__.file,name: __njsEntryData__.name,flowPathObj:__njsEntryData__.flowPathObj,methObj:__njsEntryData__.methObj,methodDepth:__njsEntryData__.methodDepth,startUpTime:__njsEntryData__.startUpTime,startSeqId:__njsEntryData__.startSeqId,methodId:__njsEntryData__.methodId,dumpedMethodName:__njsEntryData__.dumpedMethodName,cavIncludeFp:__njsEntryData__.cavIncludeFp,exception: %s, line: %s, returnValue: %s, args: %s});';
