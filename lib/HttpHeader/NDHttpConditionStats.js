...
NDHttpConditionStats.resetMonitorCounters=function(){
    for (var i in httpConditionMonitoringMap){
        httpConditionMonitoringMap[i].resetCounters();
    }
}
