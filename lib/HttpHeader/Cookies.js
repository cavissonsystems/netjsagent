...
Cookie.prototype.httpOnly = false;   //Never set to true(NV-ND integration)
...
Cookie.prototype.toHeader = function() {
    ...
    //if (this.httpOnly ) header += "; httponly"    //commenting all these because we dont need them. -Harendra
