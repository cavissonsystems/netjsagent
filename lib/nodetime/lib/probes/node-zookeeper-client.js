        ...
        try {
		    ...
		    backendName = backendRecord.generateBackendName('Zookeeper',client.connectionManager.servers[0].host,client.connectionManager.servers[0].port);
                    ...
                    if(requestedObj) {
                        ...
                        queryStartTimeMills = ((time.begin - AgentSetting.cavEpochDiffInMills ) - requestedObj.cavTimeInMillis);
                        queryStartTimeInMillis = (queryStartTimeMills) ;


                        //var backendName = obj.VENDOR + '_' + obj.Connection.host + '_' + obj.Connection.port;

                        zookeeperObj.seqId = ++requestedObj.seqId ;
                        var opt = {};
                        ...
                        zookeeperObj.queryStartTimeMills = parseInt(queryStartTimeMills);
