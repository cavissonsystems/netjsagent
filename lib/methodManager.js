...
MyFormatter.prototype.onCompleteFlowPath = function(req,res,endTime) {
    ...
    if(!req || !req['cavFlowPathId'])
        return;

    var localFlowPathId = -1;
    localFlowPathId = req['cavFlowPathId'];
    ...
    req['cavFlowPathId'] = null;
    if (agentSetting.isToInstrument && agentSetting.dataConnHandler ) {
        try {
            process.nextTick(function(){
                try {
                    var respTime = (endTime-agentSetting.cavEpochDiffInMills)-req.cavTimeInMillis;
...
MyFormatter.prototype.onExit = function(args)
{
    try {
        ...
        //if(agentSetting.excludeMethodOnRespTime > 0) {
