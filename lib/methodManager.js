...
MyFormatter.prototype.onEntry = function(args) {
    ...
    last_arg = args.args && args.args[args.args.length -1 ] && args.args[args.args.length -1][0] && args.args[args.args.length -1 ][0].toString().indexOf('Delay') !== -1 && args.args[args.args.length -1][0]
