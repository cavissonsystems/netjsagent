...
MyFormatter.prototype.onEntry = function(args) {
    ...
    var last
    last = args.args && args.args[args.args.length -1 ] && args.args[args.args.length -1][0] && args.args[args.args.length -1 ][0].indexOf('Delay') !== -1 && args.args[args.args.length -1][0]
    if(agentSetting.instrumentNodeEvents && last) {
    ...
    if(last)delete args.args[args.args.length -1]
