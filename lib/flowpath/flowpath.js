...
Flowpath.prototype.generate_4_record = function ()
{
    ...
    try {
        ...
        if (this.calls != null) {
            ...
            //RecordType,FPId,StatusCode,BTCategory,(syncTime:SuspentionTime:CPUTime),ResponseTime,BTIndex,FlowpathType,CorrelationId,SQB
            var record = '4,' + this.flowPathId + ',' + this.statusCode + ',' + this.category + ',-,' + this.respTime + ','+ this.id +',,'+(this.correlationIDHeader ? this.correlationIDHeader +",":",");
