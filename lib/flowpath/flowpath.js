...
Flowpath.prototype.generate_3_record = function(){
    ...
    var sb = new StringBuffer(),record='';
    try {
        ...
        if (this.calls != null) {
            ...
            if(agentSetting.dumpOnlyMethodExitInFP == 0)
                record = '3,' + this.flowPathId + ',';
            else if(agentSetting.dumpOnlyMethodExitInFP == 1)
                record = '43,1,'+this.flowPathId + ',';
...
Flowpath.prototype.generate_4_record = function ()
{
    ...
    try {
        ...
        if (this.calls != null) {
            ...
            if(agentSetting.dumpOnlyMethodExitInFP == 0)
               record = '4,' + this.flowPathId + ',' + this.statusCode + ',' + this.category + ',-,' + this.respTime + ',';
            else if(agentSetting.dumpOnlyMethodExitInFP == 1)
               record = '44,1,' + this.flowPathId + ',' + this.statusCode + ',' + this.category + ',-,' + this.respTime + ',';
